...
# 加载数据（绝对路径+指定编码）
books = pd.read_csv(r"C:\Users\y1598\IdeaProjects\book-recommendation-system\data\raw\Books.csv", on_bad_lines='skip', encoding='latin-1')
users = pd.read_csv(r"C:\Users\y1598\IdeaProjects\book-recommendation-system\data\raw\Users.csv", on_bad_lines='skip', encoding='latin-1')
ratings = pd.read_csv(r"C:\Users\y1598\IdeaProjects\book-recommendation-system\data\raw\Ratings.csv", on_bad_lines='skip', encoding='latin-1')
...
if __name__ == "__main__":
    ...
    processed_dir = r"C:\Users\y1598\IdeaProjects\book-recommendation-system\data\processed"
