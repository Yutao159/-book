...
sys.path.append("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\src")
...
user_emb = pd.read_csv("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\features\\user_embedding.csv", encoding='utf-8-sig')
book_emb = pd.read_csv("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\features\\book_embedding.csv", encoding='utf-8-sig')

# 2. 加载用户/书籍特征（含分类特征category_enc）
user_features = pd.read_csv("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\features\\user_basic_features.csv", encoding='utf-8-sig')
book_features = pd.read_csv("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\features\\book_basic_features.csv", encoding='utf-8-sig')

# 3. 加载排序模型（含分类特征的训练后模型）
try:
    ranking_model = joblib.load("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\models\\ranking_model.pkl")
except Exception as e:
    print(f"排序模型加载失败（不影响基础推荐）：{e}")
    ranking_model = None

# 4. 加载基础数据
ratings_df = pd.read_csv("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\processed\\ratings.csv", encoding='utf-8-sig')
books_df = pd.read_csv("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\processed\\books.csv", encoding='utf-8-sig')
...
def rank_books(user_id, recall_books):
    ...
    for isbn in recall_books:
        ...
        book_feat_cols = ['author_enc', 'publisher_enc', 'publish_year_norm']
