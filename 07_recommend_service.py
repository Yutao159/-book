...
# 定义数据文件路径
USERS_FILE = "C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\processed\\users.csv"
RATINGS_FILE = "C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\processed\\ratings.csv"
...
def submit_rating():
    try:
        ...
        # 检查书籍是否存在
        books_df = pd.read_csv("C:\\Users\\y1598\\IdeaProjects\\book-recommendation-system\\data\\processed\\books.csv", encoding='latin-1')
